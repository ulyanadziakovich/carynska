<template>
  <section id="contact" class="bg-forest border-t border-gold/20">
    ...
    <div class="w-full h-72">
      <iframe
        src="https://maps.google.com/maps?q=Przystan+Carynska+Polanczyk+Rowna+19&t=&z=15&ie=UTF8&iwloc=&output=embed"
        class="w-full h-full"
    ...
    <div class="max-w-7xl mx-auto px-8 lg:px-16 py-16 grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-12 lg:gap-20 items-start">
      ...
      <div class="flex flex-col gap-5 lg:min-w-56">
        ...
        <div class="flex flex-col gap-2 text-sm font-sans">
          <span class="text-white/50">Polańczyk, ul. Równa 19</span>
          <a href="mailto:przystan@carynska.pl" class="text-gold/70 hover:text-gold transition-colors">przystan@carynska.pl</a>
        </div>
        <!-- Social -->
        <div class="flex gap-3 pt-1">
          <a href="https://www.facebook.com/PrzystanCarynska" target="_blank"
          ...
          <a href="https://www.instagram.com/przystan_carynska" target="_blank"
             class="w-8 h-8 border border-white/15 hover:border-gold flex items-center justify-center text-white/40 hover:text-gold transition-all duration-200">
            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-px bg-gold/10">
        ...
        >
          ...
          <a
            ...
            class="flex items-center gap-3 group/phone mt-1"
          >
            <div class="w-6 h-px bg-gold/40 group-hover/phone:w-10 transition-all duration-300" />
            <span class="text-white/80 font-sans text-sm tracking-wider group-hover/phone:text-gold transition-colors duration-200">
              {{ dept.phone }}
            </span>
          </a>
        </div>
    ...
    <div class="border-t border-white/10 py-5 px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div class="flex gap-3">
        <a v-for="p in platforms" :key="p.label" :href="p.href" target="_blank"
